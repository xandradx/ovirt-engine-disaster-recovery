...
drp.updatingdbconnections = Actualizando conexiones de base de datos
...
drp.testingdb = Verificando conexiones
drp.testingdb.success = Conexión a base de datos exitosa
...
drp.db.couldnotconnect = No se pudo establecer la conexión con la base de datos
drp.db.nodriver = No existe un controlador para la conexión
drp.db.couldnotdisconnect = No se pudo desconectar de la base de datos
drp.noconnections = No existen conexiones configuradas.
